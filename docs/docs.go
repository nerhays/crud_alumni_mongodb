        ...
        "/alumni/pag": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Kolom pengurutan (nama/nim/angkatan/tahun_lulus/email)",
                        "name": "sortBy",
                        "in": "query"
                    },
                    {
        ...
        "/file/{category}": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Jenis file (foto/sertifikat)",
                        "name": "category",
                        "in": "path",
                        "required": true
                    }
